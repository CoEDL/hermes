...
class ManifestWindow(QDialog):
    ...
    def init_ui(self):
        self.setWindowTitle('Confirm Manifest Details')
        ...
        self.widgets.transcription_language_field.setText(self.parent.session.data_transcription_language)
        ...
        self.widgets.translation_language_field.setText(self.parent.session.data_translation_language)
        ...
        self.widgets.author_name_field.setText(self.parent.session.data_author)
